          ...
          <div className="space-y-5">
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                <label className="block font-sans text-[11px] tracking-[0.3em] uppercase text-[#2C2C2C]/50">
                  Password
                </label>
                <Link
                  href="/forgot-password"
                  className="font-sans text-[11px] tracking-[0.2em] uppercase text-[#6B7C5C] hover:text-[#2C2C2C] transition-colors duration-200"
                >
                  Forgot?
                </Link>
              </div>
